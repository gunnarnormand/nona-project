...
if ( is_404() ) {
	nona()->print_styles( 'nona-banner' );
	?>
	<header class="page-header">
		<div class="header-content">
			<h1 class="page-title">
				<?php esc_html_e( 'Oops! That page can&rsquo;t be found.', 'nona' ); ?>
			</h1>
		</div>
	...
	<header class="page-header">
		<div class="header-content">
			<h1 class="page-title">
				<?php esc_html_e( 'Nothing Found', 'nona' ); ?>
			</h1>
		</div>
		<svg class="banner-illustration" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 1311.88 828">
			<defs>
		...
		<div class="header-content">
			<h1 class="page-title">
				...
				printf(
					...
					esc_html__( 'Search Results for: %s', 'nona' ),
