...
function initNavToggleScrolledState() {
  var $header = document.querySelector('header#masthead'); // check if header exists

  if (!$header) {
    return;
  }

  var $headerBg = document.querySelector('.site-branding');
...
function toggleSubMenu(parentMenuItem, forceToggle) {
  ...
  if (parentMenuItemToggled) {
    ...
    toggleButton.setAttribute('aria-label', nonaScreenReaderText.expand); // Make sure all children are closed.
    ...
    toggleButton.setAttribute('aria-label', nonaScreenReaderText.collapse);
  }
}
/**
...
function getDropdownButton() {
  ...
  dropdownButton.setAttribute('aria-label', nonaScreenReaderText.expand);
