...
class Component implements Component_Interface {
	...
	public function action_register_hero_customizer_controls( WP_Customize_Manager $wp_customize ) {
		...
		$wp_customize->add_control(
			'hero_textarea',
			array(
				'label'    => __( 'Hero Text Area Content', 'nona' ),
				'section'  => 'theme_options',
	...
	public function action_register_mission_customizer_controls( WP_Customize_Manager $wp_customize ) {
		...
		$wp_customize->add_control(
			'mission_textarea',
			array(
				'label'    => __( 'Mission Text Area Content', 'nona' ),
				'section'  => 'theme_options',
	...
	public function action_register_about_customizer_controls( WP_Customize_Manager $wp_customize ) {
		...
		$wp_customize->add_control(
			'first_about_title',
			array(
				'label'    => __( 'First About Title', 'nona' ),
				'section'  => 'theme_options',
		...
		$wp_customize->add_control(
			'first_about_content',
			array(
				'label'    => __( 'First About Content', 'nona' ),
				'section'  => 'theme_options',
		...
		$wp_customize->add_control(
			'second_about_title',
			array(
				'label'    => __( 'Second About Title', 'nona' ),
				'section'  => 'theme_options',
		...
		$wp_customize->add_control(
			'second_about_content',
			array(
				'label'    => __( 'Second About Content', 'nona' ),
				'section'  => 'theme_options',
		...
		$wp_customize->add_control(
			'third_about_title',
			array(
				'label'    => __( 'Third About Title', 'nona' ),
				'section'  => 'theme_options',
		...
		$wp_customize->add_control(
			'third_about_content',
			array(
				'label'    => __( 'Third About Content', 'nona' ),
				'section'  => 'theme_options',
